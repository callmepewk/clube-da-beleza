...
export default function Layout({ children }) {
  ...
  // Define all available pages as requested
  const navItems = [
  ...
  // If on onboarding page, show a simplified layout but still horizontal header
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-900">
      ...
      {/* Registration Banner for Guest/Incomplete Users */}
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                <div className="flex flex-col h-full pt-6">
                  ...
                  {user && (
                     <div className="border-t border-slate-100 pt-4 mt-4 pb-6">
                        <button 
                          onClick={handleLogout}
                          className="flex items-center gap-3 px-3 py-3 w-full rounded-lg text-red-600 hover:bg-red-50 font-medium"
                        >
